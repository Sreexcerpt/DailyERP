...
const Sidebar = () => {
    ...
    // Define parent-child relationships for nested submenus
    const submenuRelationships = {
        purchasereport: 'purchase',
        salesreport: 'sales',
        inventoryreport: 'inventory',
        accountsreport: 'accounts',
        vendorBilling: 'invoice',
        billing: 'invoice',
    };
        ...
        setOpenSubmenus(prevState => {
            ...
            if (parentKey) {
                ...
                Object.keys(newState).forEach(submenuKey => {
                    if (submenuKey !== key && submenuKey !== parentKey) {
                ...
                // For main submenus, close all others
                Object.keys(newState).forEach(submenuKey => {
                    if (submenuKey !== key) {
                        newState[submenuKey] = false;
                    }
                                            ...
                                            <ul style={{ display: openSubmenus.inventory ? "block" : "none" }}>
                                                ...
                                                <li className="submenu submenu-two">
                                                    <a
                                                        style={{ cursor: "pointer" }}
                                                        className={
                                                            ["/MatrialReceiptList", "/MaterialIssueList"].some(path => isActive(path)) || openSubmenus.inventoryreport
                                                                ? "active subdrop"
                                                                : ""
                                                        }
                                                        onClick={e => {
                                                    ...
                                                    <ul
                                                        ...
                                                        {hasSubPermission("Inventory", "Material Issue List") && (
                                                            <li><a href="/MaterialIssueList" className={isActive("/MaterialIssueList") ? "active" : ""}>Material Issue List</a></li>
                                                        )}
                                                        {hasSubPermission("Inventory", "Material Issue List") && (
                                                            <li><a href="/MatrialTransferList" className={isActive("/MatrialTransferList") ? "active" : ""}>Material Transfer List</a></li>
                                                        )}
                                                    </ul>
                                                </li>
                                            </ul>
                                ...
                                <li>
                                    <ul>
                                        <li className="submenu">
                                            ...
                                            >
                                                <i className="ti ti-user-circle"></i><span>HRMS</span>
                                                <span className="menu-arrow"></span>
                                            </a>
                                            <ul style={{ display: openSubmenus.hrms ? "block" : "none" }}>
                                                {hasSubPermission("HRMS", "Designation") && (
                                                    <li><a href="/designation" className={isActive("/designation") ? "active" : ""}>Designation</a></li>
                                                )}
                                                {hasSubPermission("HRMS", "Department") && (
                                                    <li><a href="/departments" className={isActive("/departments") ? "active" : ""}>Departments</a></li>
                                                )}
                                                {hasSubPermission("HRMS", "Employee") && (
                                                    <li><a href="/employee" className={isActive("/employee") ? "active" : ""}>Employee</a></li>
                                                )}
                                                {hasSubPermission("HRMS", "LeaveRequests") && (
                                                    <li><a href="/leaverequest" className={isActive("/leaverequest") ? "active" : ""}>Leave Request</a></li>
                                                )}
                                                {hasSubPermission("HRMS", "LeaveRequestManagement") && (
                                                    <li><a href="/leavemanagement" className={isActive("/leavemanagement") ? "active" : ""}>Leave Management</a></li>
                                                )}
