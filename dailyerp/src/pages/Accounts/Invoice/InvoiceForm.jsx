...
function InvoiceForm() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api/invoicecategory")
    ...
    if (searchRowIndex !== null && selectedPO?.items) {
      ...
      if (updatedItems[searchRowIndex]) {
        updatedItems[searchRowIndex] = {
          ...
          price: mat.price,
          priceUnit: mat.priceUnit || formData.priceUnit,
        };
  ...
  // New functions for miscellaneous items
  ...
  const removeMiscItem = (index) => {
    if (miscItems.length > 1) {
      const updatedItems = miscItems.filter((_, i) => i !== index);
      setMiscItems(updatedItems);
    }
  };
  ...
  const handleInvoiceTypeChange = (type) => {
    ...
    if (type === "misc") {
      setSelectedPO(null);
      // Reset vendor if switching to misc
      setFormData(prev => ({ ...prev, vendor: "", location: "" }));
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const invoice = {
      ...formData,
      invoiceType, // Add invoice type to the payload
      purchaseOrderId: invoiceType === "po" ? selectedPO._id : null,
      items: invoiceType === "po" ? selectedPO.items : miscItems,
      receiptDate: today,
    ...
    <div className="content">
      <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div className="my-auto">
          <h2 className="mb-1">Vendor Invoice Creation</h2>
          <nav>
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item active" aria-current="page">Vendor Invoice Creation</li>
            </ol>
          </nav>
        </div>
      </div>
                ...
                <div className="d-flex gap-3">
                  <div className="form-check">
                    <input
                      ...
                      id="poInvoice"
                      value="po"
                      checked={invoiceType === "po"}
                      onChange={(e) => handleInvoiceTypeChange(e.target.value)}
                    />
                    <label className="form-check-label" htmlFor="poInvoice">
                  ...
                  <div className="form-check">
                    <input
                      ...
                      id="miscInvoice"
                      value="misc"
                      checked={invoiceType === "misc"}
                      onChange={(e) => handleInvoiceTypeChange(e.target.value)}
                    />
                    <label className="form-check-label" htmlFor="miscInvoice">
                ...
                <div className="row mb-2">
                  ...
                  <div className="col-md-7">
                    ...
                    >
                      <option value="">Select</option>
                      {taxes.map((t) => (
                        <option key={t._id} value={t.taxCode}>
                          {t.taxCode} - {t.taxName}
                        </option>
                      ))}
                    </select>
            ...
            <div className="table-responsive">
              {invoiceType === "po" ? (
                ...
                <table className="table table-bordered">
                  ...
                  <tbody>
                    {(selectedPO?.items?.length ? selectedPO.items : [{}]).map(
                      (item, idx) => (
                        <tr key={idx}>
                          <td>{idx + 1}</td>
                          <td>
                          ...
                          <td>
                            <input
                              ...
                              value={item.hsnNo || ""}
                              onChange={(e) =>
                                handleItemChange(idx, "hsnNo", e.target.value)
                              }
                            />
                          </td>
                          <td>
                        ...
                        <tr key={idx}>
                          ...
                          <td>
                            <input
                              ...
                              value={item.description}
                              onChange={(e) =>
                                handleMiscItemChange(idx, "description", e.target.value)
                              }
                          ...
                          <td>
                            <input
                              ...
                              value={item.hsnNo}
                              onChange={(e) =>
                                handleMiscItemChange(idx, "hsnNo", e.target.value)
                              }
                          ...
                          <td>
                            <input
                              ...
                              value={item.quantity}
                              onChange={(e) =>
                                handleMiscItemChange(idx, "quantity", e.target.value)
                              }
                              min="0"
                              step="0.01"
                            />
                          ...
                          <td>
                            <input
                              ...
                              value={item.baseUnit}
                              onChange={(e) =>
                                handleMiscItemChange(idx, "baseUnit", e.target.value)
                              }
                              placeholder="Unit"
                            />
                          </td>
                          <td>
                            <input
                              ...
                              value={item.price}
                              onChange={(e) =>
                                handleMiscItemChange(idx, "price", e.target.value)
                              }
                              min="0"
                              step="0.01"
                            />
            ...
            <div className="modal-content">
              <div className="modal-header bg-primary text-white">
                <h5 className="modal-title">
                  <i className="fas fa-users me-2"></i>Select Vendor
                </h5>
                <button
                  type="button"
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="input-group">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        placeholder={`Search by ${vendorSearchType}`}
                        value={vendorSearch}
                  ...
                  <div className="col-md-3">
                    ...
                    <div className="d-flex gap-2">
                      <button
                        ...
                        onClick={() => setViewAllVendors(true)}
                      >
                        View All
                      </button>
                  ...
                  {filteredVendors.length > 0 ? (
                    ...
                    <div className="text-center py-4">
                      ...
                      <p className="text-muted">
                        {vendorSearch
                          ? `No vendors found for "${vendorSearch}"`
        ...
        >
          <div className="modal-dialog modal-xl">
            <div className="modal-content">
              <div className="modal-header bg-primary text-white">
                <h5 className="modal-title">
                  <i className="fas fa-search me-2"></i>Select Purchase Order
                </h5>
                <button
                  type="button"
                  className="btn-close btn-close-white"
                ...
                <div className="row mb-3">
                  <div className="col-md-3">
                    ...
                    <select
                      className="form-select"
                      value={poSearchType}
                      onChange={(e) => setPoSearchType(e.target.value)}
                    >
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="input-group">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        placeholder={`Search by ${poSearchType}`}
                        value={poSearch}
                ...
                <div style={{ maxHeight: "400px", overflowY: "auto" }}>
                  {filteredPOs.length > 0 ? (
                    ...
                    <div className="text-center py-4">
                      ...
                      <p className="text-muted">
                        {poSearch
                          ? `No purchase orders found for "${poSearch}"`
                          : 'Enter search term or click "View All"'}
                      </p>
                    </div>
                  )}
      ...
      {invoiceType === "po" && showMaterialModal && (
        <div
          className="modal show d-block"
          tabIndex="-1"
          style={{ backgroundColor: "rgba(0,0,0,0.5)" }}
        >
          <div className="modal-dialog modal-xl">
            <div className="modal-content">
              <div className="modal-header bg-primary text-white">
                <h5 className="modal-title">
                  <i className="fas fa-box-open me-2"></i>Select Material
                </h5>
                <button
                  type="button"
                  className="btn-close btn-close-white"
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="input-group">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        placeholder={`Search by ${materialSearchType}`}
                  ...
                  <div className="col-md-3">
                    ...
                    <div className="d-flex gap-2">
                      <button
                        className="btn btn-info"
                        onClick={() => setViewAllMaterials(true)}
                      >
                        View All
                      </button>
