...
function SalesQuotationForm() {
  ...
  const fetchSavedQuotations = () => {
    axios
      .get("http://localhost:8080/api/salesquotations")
  ...
  const [quotationNumberType, setQuotationNumberType] = useState('internal');
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Show quotation number modal instead of directly submitting
    setShowQuotationModal(true);
  };

  // Add this new function for final submission:
  const handleFinalSubmit = () => {
    const data = {
      ...
      items,
      quotationNumberType,
      externalQuotationNumber: quotationNumberType === 'external' ? externalQuotationNumber : null
    };

    axios
      .post("http://localhost:8080/api/salesquotations", data)
      .then(() => {
  ...
  // Add this line in your return statement, after the other modals:
