...
function QuotationForm() {
  ...
  const [quotationGenType, setQuotationGenType] = useState('internal'); // 'internal' or 'external'
  ...
  //       "http://localhost:8080/api/quotations/create",
  //       payload
  //     );
  ...
  const handleSubmit = async (e) => {
    ...
    // Show the quotation number generation modal first
  ...
  const handleFinalSubmit = async () => {
    ...
    const payload = {
      ...
      totalPrice,
      items,
      quotationGenType, // Add generation type
      externalQuotationNumber: quotationGenType === 'external' ? externalQuotationNumber : null // Add external number if applicable
    };
          ...
          <div className="my-auto mb-2">
            ...
            <nav>
              <ol className="breadcrumb mb-0">
                ...
                <li className="breadcrumb-item active" aria-current="page">Purchase Quotation</li>
              </ol>
            </nav>
          </div>
