...
//         // Example financial months (you can modify this or fetch from backend)
//         setMonths(["Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar"]);
//     }, []);
//     useEffect(() => {
//         const calculateMonthlyGSTSummary = () => {
//             const monthMap = {};

//             // Combine both vendor (input) and customer (output) invoices
...
//                 const invoiceMonth = new Date(invoice.createdAt).toLocaleString('en-US', { month: 'short' });
//                 const gst = (invoice.cgst || 0) + (invoice.sgst || 0) + (invoice.igst || 0);
//                 if (monthMap[invoiceMonth]) {
//                     monthMap[invoiceMonth].input += gst;
//                 }
//             });
...
//                 const gst = (invoice.cgst || 0) + (invoice.sgst || 0) + (invoice.igst || 0);
//                 if (monthMap[invoiceMonth]) {
//                     monthMap[invoiceMonth].output += gst;
//                 }
//             });
...
//         }
//     }, [vendorinvoices, customerInvoices]);
...
//                     // Convert createdAt to short month (e.g. "Jul")
//                     const invoiceMonth = new Date(invoice.createdAt).toLocaleString('en-US', { month: 'short' });
...
//                                             <select name="month" className="form-select" id="month-select" onChange={(e) => setSelectedMonth(e.target.value)}>
...
//                                     <div className="tab-pane fade show active p-0 border-bottom-0" id="products-tab-pane"
...
//                                         </div>
//                                     </div>
//                                     <div className="tab-pane fade" id="sales-tab-pane" role="tabpanel"
...
//                                         </div>
//                                     </div>
//                                     <div className="tab-pane fade" id="profit-tab-pane" role="tabpanel"
