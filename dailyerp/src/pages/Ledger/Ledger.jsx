...
//       const debit = item.category?.toLowerCase() === "debit" ? (item.finalTotal || item.netAmount || 0) : 0;
//       const credit = item.category?.toLowerCase() === "credit" ? (item.finalTotal || item.netAmount || 0) : 0;
//       const balance = item.balance || 0;

//       return {
//         totalDebit: acc.totalDebit + debit,
//         totalCredit: acc.totalCredit + credit,
//         totalBalance: acc.totalBalance + (credit - debit),
...
//       const debit = item.category?.toLowerCase() === "debit" ? (item.finalTotal || 0) : 0;
//       const credit = item.category?.toLowerCase() === "credit" ? (item.finalTotal || 0) : 0;
//       const balance = item.balance || 0;

//       return {
//         totalDebit: acc.totalDebit + debit,
//         totalCredit: acc.totalCredit + credit,
//         totalBalance: acc.totalBalance + (debit - credit),
//         outstandingBalance: acc.outstandingBalance + balance
//       };
//     }, { totalDebit: 0, totalCredit: 0, totalBalance: 0, outstandingBalance: 0 });
...
//     debit: item.category?.toLowerCase() === "debit" ? (item.finalTotal || item.netAmount || 0) : 0,
//     credit: item.category?.toLowerCase() === "credit" ? (item.finalTotal || item.netAmount || 0) : 0,
//     balance: item.balance || 0, // Use the actual balance field from database
...
//     debit: item.category?.toLowerCase() === "debit" ? (item.finalTotal || 0) : 0,
//     credit: item.category?.toLowerCase() === "credit" ? (item.finalTotal || 0) : 0,
//     balance: item.balance || 0, // Use the actual balance field from database
...
//                               <td className="text-end text-danger">{formatCurrency(entry.debit)}</td>
//                               <td className="text-end text-success">{formatCurrency(entry.credit)}</td>
//                               <td className="text-end">
//                                 <strong className={`text-${entry.balance > 0 ? 'danger' : 'success'}`}>
