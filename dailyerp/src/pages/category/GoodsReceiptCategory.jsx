...
const GoodsReceiptCategory = () => {
  ...
  const financialYear = localStorage.getItem('financialYear');
      ...
      const res = await axios.get('http://localhost:8080/api/goodsreceiptcategory',{ params: { companyId, financialYear }});
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await axios.put(`http://localhost:8080/api/goodsreceiptcategory/${editingId}`, formData);
        alert('Category updated successfully!');
      } else {
        await axios.post('http://localhost:8080/api/goodsreceiptcategory', formData);
          ...
          <div className="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
            ...
            <div>
              <a onClick={handleOpenModal} className="btn btn-primary d-flex align-items-center">
                <i className="isax isax-add-circle5 me-1"></i>Goods Receipt Category
              </a>
            </div>
          </div>
        </div>
              ...
              <div className="modal-dialog modal-lg">
                <div className="modal-content">
                  <div className="modal-header">
                    <h4 className="modal-title">{editingId ? 'Edit' : 'Create'} Goods Receipt Category</h4>
...
export default GoodsReceiptCategory;
