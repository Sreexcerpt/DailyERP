...
const InvoiceCategory = () => {
  ...
  const fetchCategories = async () => {
    try {
      const res = await axios.get('http://localhost:8080/api/invoicecategory', { params: { companyId, financialYear } });
          ...
          <div className="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
            ...
            <div>
              <a onClick={handleOpenModal} className="btn btn-primary d-flex align-items-center">
                <i className="ti ti-plus me-1"></i>Add vendor Invoice Category
              </a>
            </div>
          </div>
        </div>
