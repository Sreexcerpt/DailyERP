...
const GoodsIssueCategory = () => {
  ...
  const financialYear = localStorage.getItem('financialYear');
      ...
      const res = await axios.get('http://localhost:8080/api/goodsissuecategory',{  params: { companyId, financialYear }});
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await axios.put(`http://localhost:8080/api/goodsissuecategory/${editingId}`, formData);
        alert('Category updated successfully!');
      } else {
        await axios.post('http://localhost:8080/api/goodsissuecategory', formData);
          ...
          <div className="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
            ...
            <div>
              <a onClick={handleOpenModal} className="btn btn-primary d-flex align-items-center">
                <i className="isax isax-add-circle5 me-1"></i>Goods Issue Category
              </a>
            </div>
          </div>
        </div>
              ...
              <div className="modal-dialog modal-lg">
                <div className="modal-content">
                  <div className="modal-header">
                    <h4 className="modal-title">{editingId ? 'Edit' : 'Create'} Goods Issue Category</h4>
...
export default GoodsIssueCategory;
